...
def parse_cmd_line_args():
    ...
    p.add_option("-u", "--unmarshall",
                                    action="store_true", dest="unmarshall", default=False, help="Unmarshall a .pyc file and run in on bytecode interpreter")
...
def get_exec(cmd_class="org.python.util.jruby", action_args=[]):
    ...
    def exec_closure(args=[], host_vm_opts='', client_vm_opts='', use_maxine=False, use_inspector=False, errors=[]):
        ...
        if opts.unmarshall:
            ...
            rearranged_action_args = ''.join(action_args)
            ...
            unmarshalScript = os.path.join(get_maxine_scripts(), 'unmarshall.py')
            arguments = unmarshalScript + ' ' + arguments
        else:
...
#          , ("hotspot", "java")
    ...
    host_vms= [
          #("jrubyMaxineCompilation", "org.python.util.jruby ", "")
          ("jruby", "org.python.util.jruby -trun", "")
          #, ("jrubyCompilation", "org.python.util.jruby -tcompile", "")
          #("bi", "org.python.util.jruby -tinterpret " + os.path.join(get_maxine_scripts(), 'unmarshall.py'), "unmarshal")
          #, ("biInline", "org.python.util.jruby -tinterpret " + os.path.join(get_maxine_scripts(), 'unmarshall.py'), "unmarshal")
          #("siMaxineCompilation", "org.python.util.jruby -si " + os.path.join(get_maxine_scripts(), 'unmarshall.py'), "unmarshal")
          , ("si", "org.python.util.jruby -si -tinterpret " + os.path.join(get_maxine_scripts(), 'unmarshall.py'), "unmarshal")
          #, ("ui", "org.python.util.jruby -ui -tinterpret " + os.path.join(get_maxine_scripts(), 'unmarshall.py'), "unmarshal")
          #("di", "org.python.util.jruby -di -tinterpret " + os.path.join(get_maxine_scripts(), 'unmarshall.py'), "unmarshal")
          #, ("oi", "org.python.util.jruby -oi -tinterpret " + os.path.join(get_maxine_scripts(), 'unmarshall.py'), "unmarshal")
        ]
